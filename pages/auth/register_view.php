                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input
                                    ...
                                    required
                                >
                                <button type="button" class="btn btn-outline-secondary" onclick="togglePass('passwordInput', 'eyeIcon1')" tabindex="-1">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <input
                                    ...
                                    required
                                >
                                <button type="button" class="btn btn-outline-secondary" onclick="togglePass('confirmInput', 'eyeIcon2')" tabindex="-1">
