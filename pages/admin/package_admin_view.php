<div class="container-fluid py-4">
    ...
    <table class="table mb-0 align-middle" style="--bs-table-bg: transparent; --bs-table-color: #fff;">
</div>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="day_duration"
                            class="form-control bg-dark text-white border-secondary" placeholder="30" min="1" required>
                    </div>
                    <div class="mb-3">
