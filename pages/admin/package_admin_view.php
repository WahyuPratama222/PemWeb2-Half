<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="text-white fw-bold mb-0">Manajemen Paket</h4>
    ...
    <?php if (empty($packages)): ?>
        <div class="alert alert-secondary text-white-50">Belum ada paket tersedia.</div>
    <?php else: ?>
                            ...
                            <?php foreach ($packages as $i => $p): ?>
                                <tr>
                                    ...
                                    <td class="text-end pe-4">
                                        <a href="<?= BASE_URL ?>admin/packages.php?edit=<?= $p['id_package'] ?>"
